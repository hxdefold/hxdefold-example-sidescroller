...
local BonusStar = _hx_empty()
local Factory = _hx_empty()
local LargePlanets = _hx_empty()
local Main = _hx_empty()
local Math = _hx_empty()
local Messages = _hx_empty()
local Reflect = _hx_empty()
local SmallPlanets = _hx_empty()
local Spaceship = _hx_empty()
local Star = _hx_empty()
local String = _hx_empty()
local Std = _hx_empty()
defold.GoMessages = _hx_empty()
defold.PhysicsMessages = _hx_empty()
defold.RenderMessages = _hx_empty()
defold.SysMessages = _hx_empty()
defold.support.GuiScript = _hx_empty()
defold.types = {}
